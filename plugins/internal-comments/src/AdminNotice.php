...
use DeepWebSolutions\InternalComments\Scoped\DeepWebSolutions\Framework\Core\Contracts\HookableInterface;
...
final class AdminNotice implements HookableInterface {
	...
	public function render(): void {
		printf(
			...
			esc_html__( 'Internal Comments is active.', 'internal-comments' )
		);
	}
