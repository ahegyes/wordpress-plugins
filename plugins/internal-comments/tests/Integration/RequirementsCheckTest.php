...
use function DeepWebSolutions\InternalComments\Scoped\DeepWebSolutions\Framework\Bootstrap\check_requirements;
use function DeepWebSolutions\InternalComments\Scoped\DeepWebSolutions\Framework\Bootstrap\get_plugin_metadata;

final class RequirementsCheckTest extends TestCase {
	private string $basename = 'internal-comments/internal-comments.php';
