...
use function DeepWebSolutions\LinkedOrders\Scoped\DeepWebSolutions\Framework\Bootstrap\check_requirements;
use function DeepWebSolutions\LinkedOrders\Scoped\DeepWebSolutions\Framework\Bootstrap\get_plugin_metadata;

final class RequirementsCheckTest extends TestCase {
	private string $basename = 'linked-orders-for-woocommerce/linked-orders-for-woocommerce.php';
